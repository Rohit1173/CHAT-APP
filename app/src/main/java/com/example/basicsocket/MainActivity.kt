...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // supportActionBar?.setTitle("ROOM NAME : "+room)
        //val tool_text:TextView=findViewById(R.id.toolbar_name)
        try {
    ...
    override fun onBackPressed() {
        add_message(message("a", "$name has left the chat ",3))
       // msocket.emit("disconnect",name)
      // super.onBackPressed()
